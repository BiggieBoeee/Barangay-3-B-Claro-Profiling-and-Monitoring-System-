      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="searchprof.html">Constituent Profile</a>
            ...
            <a class="dropdown-item" href="blank.html">Reservation</a>
            <a class="dropdown-item" href="blank.html">Schedule</a>
          </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="searchprof.html">Incident Cases</a>
            <a class="dropdown-item" href="login.html">Events</a>
            <a class="dropdown-item" href="register.html">Reservation</a>
            <a class="dropdown-item" href="forgot-password.html">Schedule for Tanods</a>
